Pod::Spec.new do |s|
  ...
  s.subspec 'Main' do |ss|
    ss.ios.dependency 'AppsFlyerFramework', '~> 6.1.1'
    ss.tvos.dependency 'AppsFlyerFramework', '~> 6.1.1'
  end
  
  s.subspec 'Strict' do |ss|
    ss.ios.dependency 'AppsFlyerFramework/Strict', '~> 6.1.1'
  end

  s.subspec 'MacCatalyst' do |ss|
    ss.ios.dependency 'AppsFlyerFramework/MacCatalyst', '~> 6.1.1'
  end
end